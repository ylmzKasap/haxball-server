...
const get_title = (wins) => { 
    ...
    if (wins === 0) {
        ...
        titleInfo.avatar = "☠"
        titleInfo.next_title = `${1085 - wins}`
        titleInfo.rank_up = wins === 1000
      } else if (wins >= 1085 && wins < 1300) {
        titleInfo.title = "🧨Pehlivan Uçurucu🧨"
        titleInfo.avatar = "🧨"
        titleInfo.next_title = `${1300 - wins}`
        titleInfo.rank_up = wins === 1085
      } else if (wins >= 1300 && wins < 1600) {
        titleInfo.title = "🎉Pehlivanötesi🎉"
        titleInfo.avatar = "🎉"
        titleInfo.next_title = `${1600 - wins}`
        titleInfo.rank_up = wins === 1300
      } else if (wins >= 1600 && wins < 2000) {
        titleInfo.title = "🎹Minder Sanatçısı🎨"
        titleInfo.avatar = "🎨"
        titleInfo.next_title = `${2000 - wins}`
        titleInfo.rank_up = wins === 1600
      } else if (wins >= 2000 && wins < 2222) {
        titleInfo.title = "🐻Sumocu Ayı🐻"
        titleInfo.avatar = "🐻"
        titleInfo.next_title = `${2222 - wins}`
        titleInfo.rank_up = wins === 2000
      } else if (wins >= 2222 && wins < 2500) {
        titleInfo.title = "👽Uzaylı Pehlivan👽"
        titleInfo.avatar = "👽"
        titleInfo.next_title = `${2500 - wins}`
        titleInfo.rank_up = wins === 2222
      } else if (wins >= 2500 && wins < 2750) {
        titleInfo.title = "👑Kral Pehlivan👑"
        titleInfo.avatar = "👑"
        titleInfo.next_title = `${2750 - wins}`
        titleInfo.rank_up = wins === 2500
      } else if (wins >= 2750 && wins < 3000) {
        titleInfo.title = "🚀GigaPehlivan🚀"
        titleInfo.avatar = "🚀"
        titleInfo.next_title = `${3000 - wins}`
        titleInfo.rank_up = wins === 2750
      } else if (wins >= 3000 && wins < 3133) {
        titleInfo.title = "🐮Katıksız Sığır🐮"
        titleInfo.avatar = "🐮"
        titleInfo.next_title = `${3133 - wins}`
        titleInfo.rank_up = wins === 3000
      } else if (wins >= 3133 && wins < 3333) {
        titleInfo.title = "🧠Beyni Yanık🧠"
        titleInfo.avatar = "🧠"
        titleInfo.next_title = `${3333 - wins}`
        titleInfo.rank_up = wins === 3133
      } else if (wins >= 3333 && wins < 3555) {
        titleInfo.title = "👀İşsiz Avare👀"
        titleInfo.avatar = "👀"
        titleInfo.next_title = `${3555 - wins}`
        titleInfo.rank_up = wins === 3333
      } else if (wins >= 3555) {
        titleInfo.title = "🏆Minder Tanrısı🏆"
        titleInfo.avatar = "🏆"
        titleInfo.next_title = null
        titleInfo.rank_up = wins === 3555
      }
...
(function (cb) {
  ...
  function Na(a) {
      ...
      var c = null,
          c = function () {
              var a = b.Dh - b.Xh();
              0 >= a ? b.bb() : (window.clearTimeout(b.Cf), (a = window.setTimeout(c, a + 1e3)), (b.Cf = a));
          };
      c();
  ...
  function wa(a, b, c) {
      ...
      this.hb = [];
      var d = this;
      this.ra = new RTCPeerConnection({ iceServers: b }, wa.qg);
      this.Le = new Promise(function (a) {
          d.Qg = a;
      });
      this.ra.onicecandidate = function (a) {
          null == a.candidate ? d.Qg(d.zd) : ((a = a.candidate), null != a.candidate && "" != a.candidate && (null != d.Hd && d.Hd(a), d.zd.push(a)));
      };
  ...
  wa.prototype = {
      ...
      sg: function (a) {
          var b = this,
              c = { id: this.hb.length, negotiated: !0, ordered: a.je };
  ...
  var Pa = (Oa["bas.basnet.ConnectionRequestResponse"] = {
      se: !0,
      Yf: ["Accept", "Reject"],
      Tf: { yd: 0, eb: "bas.basnet.ConnectionRequestResponse", toString: bb },
      nd:
          (($a = function (a) {
              return { yd: 1, reason: a, eb: "bas.basnet.ConnectionRequestResponse", toString: bb };
          }),
          ($a.ue = ["reason"]),
          $a),
  });
  ...
  fa.prototype = {
      ...
      Lg: function (a) {
          ...
          try {
              ...
              d = 0 != a.B();
              e = a.kb();
              for (var h = a.jf(), m = [], q = 0; q < h.length; ) m.push(new RTCIceCandidate(h[q++]));
              f = m;
          } catch (ib) {
              this.fc(b, 0);
              return;
      ...
      Mg: function (a, b, c, d, e, f) {
          ...
          if (16 <= this.vb.size) this.fc(a, 4104);
              ...
              k.Uh();
              k.rg(new RTCSessionDescription({ sdp: c, type: "offer" }), d);
          }
      },
      Gg: function (a) {
          var b = a.Lb(),
              c;
          try {
              (a = new C(new DataView(pako.inflateRaw(a.Ka()).buffer), !1)), (c = new RTCIceCandidate(a.jf()));
          } catch (d) {
              return;
          }
          this.Hg(b, c);
  ...
  C.ug = function (a, b) {
      ...
      else if (248 == (c & 252)) (d = a.getUint8(b + 1)), (e = a.getUint8(b + 2)), (f = a.getUint8(b + 3)), (h = a.getUint8(b + 4)), (c = ((c & 3) << 24) | ((d & 63) << 18) | ((e & 63) << 12) | ((f & 63) << 6) | (h & 63)), (b += 5);
      else if (252 == (c & 254))
          (d = a.getUint8(b + 1)),
              (e = a.getUint8(b + 2)),
              (f = a.getUint8(b + 3)),
  ...
  C.prototype = {
      ...
      Uc: function (a) {
          var b = this.a,
              c,
              d = "";
          for (a = b + a; b < a; ) (c = C.ug(this.j, b)), (b += c.length), (d += String.fromCodePoint(c["char"]));
              ...
              ? (this.j.setUint8(b + 1, (a >> 7) | 128),
                16384 <= a
                    ? (this.j.setUint8(b + 2, (a >> 14) | 128),
                      2097152 <= a
                          ? (this.j.setUint8(b + 3, (a >> 21) | 128), 268435456 <= a ? (this.j.setUint8(b + 4, (a >> 28) & 127), (a = 5)) : (this.j.setUint8(b + 3, this.j.getUint8(b + 3) & 127), (a = 4)))
                          : (this.j.setUint8(b + 2, this.j.getUint8(b + 2) & 127), (a = 3)))
  ...
  V.ei = function (a, b) {
      try {
          return window.crypto.subtle.importKey("jwk", { crv: "P-256", ext: !0, key_ops: ["verify"], kty: "EC", x: a, y: b }, V.eg, !0, ["verify"]);
      } catch (c) {
  ...
  y.fh = function () {
      ...
      M.Eg()
          ...
          .then(function () {
              ...
              window.room = window.parent.room;
  ...
  y.Th = function (a) {
      ...
      function d(a) {
          return null == a ? null : { x: a.a.x, y: a.a.y, xspeed: a.s.x, yspeed: a.s.y, xgravity: a.ma.x, ygravity: a.ma.y, radius: a.L, bCoeff: a.i, invMass: a.K, damping: a.ga, color: a.S, cMask: a.c, cGroup: a.m };
      }
      function e() {
          return null == u.C ? null : { red: u.C.Mb, blue: u.C.Fb, time: u.C.Jb, scoreLimit: u.C.$a, timeLimit: 60 * u.C.Ma };
      }
      function f(a) {
          if (null == a) return null;
          var b = null,
              c = a.N;
          null != c && (b = { x: c.a.x, y: c.a.y });
          return { name: a.pa, team: a.ja.R, id: a.na, admin: a.Rb, position: b };
      }
      function h(b, c) {
          var d = a[b];
      ...
      var A = new Fa({ iceServers: ta.Ad, oi: ta.ye + "api/host", state: u, version: 9, ti: v });
      ...
      var C = null,
          D = {
              ...
              sendAnnouncement: function (a, b, d, e, f) {
                  e = { bold: 1, italic: 2, small: 3, "small-bold": 4, "small-italic": 5 }[e];
                  null == e && (e = 0);
                  null == d && (d = -1);
                  null == f && (f = 1);
                  var h = U.V(a, d, e, f);
              ...
              CollisionFlags: { ball: 1, red: 2, blue: 4, redKO: 8, blueKO: 16, wall: 32, kick: 64, score: 128, c0: 268435456, c1: 536870912, c2: 1073741824, c3: -2147483648, all: 63 },
          };
      A.$b = function (a, b) {
  ...
  J.prototype = {
      ...
      Ba: function (a) {
          if (0 < this.Wa) 120 > this.Wa && this.Wa--;
              ...
              d = this.ia.w;
              e = 0;
              for (h = d.length; e < h; ) (f = e++), (m = d[f]), 0 != (m.m & 128) && ((J.Fe[c] = f), (f = J.Ve[c]), (m = m.a), (f.x = m.x), (f.y = m.y), ++c);
              this.ia.Ba(a);
              if (0 == this.Za) {
                  for (a = 0; a < b.length; ) (c = b[a]), ++a, null != c.N && (c.N.c = 39 | this.Bd.Vg);
                  b = this.ia.w[0].s;
                  ...
                  d != p.oa
                      ? ((this.Za = 2), (this.xb = 150), (this.Bd = d), d == p.ka ? this.Fb++ : this.Mb++, null != this.ha.zf && this.ha.zf(d.Sc), null != this.ha.kf && this.ha.kf(d.R))
                      : 0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb && (null != this.ha.Wh && this.ha.Wh(), this.wf());
              } else if (2 == this.Za)
                  this.xb--, 0 >= this.xb && ((0 < this.$a && (this.Mb >= this.$a || this.Fb >= this.$a)) || (0 < this.Ma && this.Jb >= 60 * this.Ma && this.Mb != this.Fb) ? this.wf() : (this.Oe(), null != this.ha.hf && this.ha.hf()));
              else if (3 == this.Za && (this.xb--, 0 >= this.xb && ((b = this.ha), null != b.C))) {
                  b.C = null;
                  a = 0;
                  for (c = b.ca; a < c.length; ) (d = c[a]), ++a, (d.N = null), (d.Ab = 0);
                  null != b.dd && b.dd(null);
              }
          }
      },
  ...
  n.Zg = function (a, b) {
      ...
      c.Bc = e;
      null == m
          ? ((d = b[d]), (m = b[e]), null == d || null == m ? (c.Ua = c.Ja = 100) : ((e = d.a), (m = m.a), (d = e.x - m.x), (e = e.y - m.y), (c.Ua = c.Ja = Math.sqrt(d * d + e * e))))
  ...
  n.prototype = {
      ...
      lg: function (a, b) {
          for (var c = 0, d = this.Ra; c < d.length; ) {
              ...
              var f = e.F,
                  ...
                  m = b.x - a.x,
                  g = b.y - a.y;
              0 < -(f.y - a.y) * m + (f.x - a.x) * g == 0 < -(h.y - a.y) * m + (h.x - a.x) * g
                  ? (f = !1)
                  : ((m = h.x - f.x), (h = h.y - f.y), (f = 0 < -(a.y - f.y) * m + (a.x - f.x) * h == 0 < -(b.y - f.y) * m + (b.x - f.x) * h ? !1 : !0));
              if (f) return e.ic;
          }
          return p.oa;
      },
      ...
      Oc: function (a, b, c, d, e, f, h) {
          ...
          this.u.push(n);
          m = b;
          for (b = this.u.length; m < b; ) (g = m++), (this.u[g].c = f), (this.u[g].m = h), (this.u[g].i = 0.1);
          b = this.I.length;
          this.I.push(k);
          this.I.push(p);
          this.I.push(r);
          m = b;
          for (b = this.I.length; m < b; ) (g = m++), (this.I[g].c = f), (this.I[g].m = h), (this.I[g].i = 0.1);
          f = new X();
          h = f.a;
          h.x = a;
          h.y = -c;
  ...
  E.Pf = function (a, b, c) {
      ...
      a = 0;
      for (b = d.za.length; a < b; ) (c = a++), (e = d.za[c]), null != e && ((E.Of[0] = e), (d.za[c] = E.Of[0]));
      return d;
  };
  E.M = g;
  E.prototype = v(g.prototype, {
      ...
      P: function (a) {
          ...
          e = 0;
          for (f = this.za; e < f.length; ) (h = f[e]), ++e, null != h && ((c |= d), a.v(h)), (d <<= 1);
          d = a.a;
          a.a = b;
          a.Na(c);
          a.a = d;
      ...
      W: function (a) {
          ...
          this.za = [];
          for (c = 0; 3 > c; ) (d = c++), (this.za[d] = null), 0 != (b & 1) && (this.za[d] = a.H()), (b >>>= 1);
      },
      h: E,
  });
  O.b = !0;
  ...
  la.prototype = {
      ...
      og: function (a) {
          ...
          d >= this.L ||
              ((d = this.L - d), (f = e = this.a), (e.x = f.x + b * d), (e.y = f.y + c * d), (d = this.s), (d = b * d.x + c * d.y), 0 > d && ((d *= this.i * a.i + 1), (e = a = this.s), (a.x = e.x - b * d), (a.y = e.y - c * d)));
      },
      h: la,
  };
  ka.b = !0;
      ...
      Ba: function (a) {
          ...
          if (null != b && null != a) {
              ...
              if (!(0 >= f)) {
                  ...
                  f = h - f;
                  if (0 == 0 * this.hc) (d = this.hc * f * 0.5), (e *= d), (c *= d), (g = d = b.s), (b = b.K), (d.x = g.x + e * b), (d.y = g.y + c * b), (d = b = a.s), (a = a.K), (b.x = d.x + -e * a), (b.y = d.y + -c * a);
                  else {
                      h = f * d;
                      var k = b.a,
                          l = b.a;
  ...
  za.prototype = {
      ...
      Ba: function (a) {
          ...
          for (b = this.w.length; a < b; ) {
              ...
              c = this.w[d];
              d += 1;
              for (e = this.w.length; d < e; ) (f = this.w[d++]), 0 != (f.c & c.m) && 0 != (f.m & c.c) && c.ng(f);
              if (0 != c.K) {
                  d = 0;
                  ...
                  d = 0;
                  for (e = this.I; d < e.length; ) (f = e[d]), ++d, 0 != (f.c & c.m) && 0 != (f.m & c.c) && c.og(f);
                  d = 0;
                  for (e = this.u; d < e.length; )
                      if (((f = e[d]), ++d, 0 != (f.c & c.m) && 0 != (f.m & c.c) && ((g = c.a), (k = f.a), (h = g.x - k.x), (g = g.y - k.y), (k = h * h + g * g), 0 < k && k <= c.L * c.L))) {
                          var k = Math.sqrt(k),
                              h = h / k,
                              g = g / k,
                              k = c.L - k,
  ...
  z.prototype = {
      ...
      Kb: function () {
          ...
          } else (a = this.F.a), (b = this.J.a), (c = a.x - b.x), (a = -(a.y - b.y)), (b = Math.sqrt(a * a + c * c)), (this.X = new x(a / b, c / b));
      },
      h: z,
  };
  w.b = !0;
  ...
  l.M = Error;
  l.prototype = v(Error.prototype, { h: l });
  k.b = !0;
  k.Mf = function (a) {
      ...
      switch (c) {
          ...
          case "object":
              ...
              if (a instanceof Array) {
                  ...
                  d = "[";
                  b += "\t";
                  for (f = 0; f < c; ) (e = f++), (d += (0 < e ? "," : "") + k.Ub(a[e], b));
                  return d + "]";
              }
              try {
                  d = a.toString;
  ...
  wa.qg = { mandatory: { OfferToReceiveAudio: !1, OfferToReceiveVideo: !1 } };
  V.eg = { name: "ECDSA", namedCurve: "P-256" };
  V.Qh = { name: "ECDSA", hash: { name: "SHA-256" } };
  g.Nf = new Map();
  g.Yd = 0;
  ha.U = g.$({ da: !1, Z: !1 });
  Ta.ii = [
      { name: "ro", reliable: !0, je: !0 },
      { name: "ru", reliable: !0, je: !1 },
      { name: "uu", reliable: !1, je: !1 },
  ];
  F.Uf = "application/x-www-form-urlencoded";
  ta.ye = "https://www.haxball.com/rs/";
  ta.Ad = [{ urls: "stun:stun.l.google.com:19302" }];
  y.Ge = new M();
  y.tf = !1;
  J.Ve = (function () {
  ...
  qa.U = g.$({ da: !1, Z: !1 });
  U.U = g.$({ da: !1, Z: !1, me: { Zd: 10, qe: 900 } });
  pa.U = g.$({ da: !1, Z: !1 });
  L.U = g.$({ da: !1, Z: !1 });
  T.U = g.$({ da: !1, Z: !1 });
  oa.U = g.$({ da: !1, Z: !1 });
  S.U = g.$({ da: !1, Z: !1 });
  K.U = g.$({ da: !1, Z: !1, me: { Zd: 10, qe: 2e3 } });
  da.U = g.$({ da: !1, Z: !1 });
  ca.U = g.$({ da: !1, Z: !1 });
  R.U = g.$({ da: !1, Z: !1 });
  Q.U = g.$({ da: !1, Z: !1 });
  ba.U = g.$({});
  aa.U = g.$({ da: !1, Z: !1, me: { Zd: 10, qe: 900 } });
  na.U = g.$({});
  ma.U = g.$({ da: !1, Z: !1 });
  I.U = g.$({ da: !1, Z: !1 });
  P.U = g.$({ da: !1, Z: !1 });
